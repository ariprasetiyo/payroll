 ...
 * @author arprast
 */
public class domainPayrollData_printSlipGaji {
       String id, area, nama, jabatan,statusPegawai, jenisKelamin, noHP, gaji,t_kerajinan ,t_operational,t_bpjs_ketenagakerjaan ,t_bpjs_kesehatan , t_lainnya,t_kesehatan ,t_penepatan,
    ...
    p_bpjs_ketenagakerjaan, p_bpjs_kesehatan,  p_asr_kesehatan ,  p_denda_kedisiplinan, p_pajak,
            user_created,user_updated, tanggal_dibuat, tanggal_update,  lembur, totalPendapatan, totalPotongan, totalPendapatan2, takeHomePay;
